    ...
    public Inregistrare() {
        try {
            ...
            try (Connection connection = Bazadedate.getConnection()) {
                String insert = "INSERT INTO persoane (Nume, Prenume, Data_nasterii, Telefon, Email, Domiciliu, Cetatenie, PIN, Sold, Valuta) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
                ...
                try (PreparedStatement preparedStatement = connection.prepareStatement(insert)) {
                    ...
                    preparedStatement.setString(9, contNou.getSold());
                    preparedStatement.setString(10, String.valueOf(contNou.getValuta()));
