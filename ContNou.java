...
public class ContNou {
    ...
    private String sold="0.0";
    private String valuta="RON";
    ...
    public void initializetastatura() {
        ...
        try {
            ...
            this.sold = scanner.next();

            if (!sold.matches("\\d+(\\.\\d+)?")) {
                throw new IllegalArgumentException("Soldul trebuie sa fie un numar valid.");
            }

            System.out.print("Valuta:");
            this.valuta = scanner.next();

            if (!valuta.matches("[RON;EUR;USD;GBP]{3}")) {
                throw new IllegalArgumentException("Valuta trebuie sa fie un cod de 3 litere.");
            }
